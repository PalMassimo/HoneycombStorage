package units.progettotomcat.classes;
 ...
 * @author massi
 */
public class MailServlet implements Runnable {

    private final String MITTENTE = "progettoprogrammazioneweb@gmail.com";
    private final String host = "http://localhost:8080/ProgettoTomCat/api/consumerarea/file/";
